...
Promise.all([loadAsync('models/animation.glb'), loadAsync('models/blueroom.glb'), loadAsync('models/bluemudkip.glb')]).then(models => {
  ...
  // Play a certain animation
  const clipx = THREE.AnimationClip.findByName(clipz, 'Object_3Action');

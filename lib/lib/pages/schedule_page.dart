...
Widget tableCalendar(BuildContext context)  {
    return TableCalendar(
      ...
      headerStyle: HeaderStyle(
        ...
        calendarStyle: CalendarStyle(tablePadding: EdgeInsets.only(top: 10),),
...
class EventItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      subtitle: Text(
        TimeOfDay(hour: event.startH, minute: event.startM).format(context) + ' until ' + 
